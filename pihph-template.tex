...
\usepackage[backend=biber,
       bibstyle=biblatex-sp-unified, % biblatex-sp-unified.bbx can be obtained at https://github.com/semprag/biblatex-sp-unified
       citestyle=sp-authoryear-comp, % sp-authoryear-comp.cbx can be obtained at https://github.com/semprag/biblatex-sp-unified
       mincrossrefs=50,
       maxcitenames=3,
       maxbibnames=50,
       useprefix=true,
